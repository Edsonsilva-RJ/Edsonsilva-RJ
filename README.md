...
Sou um profissional em transição de carreira com mais de 10 anos de experiência no setor de serviços, onde desenvolvi competências interpessoais resilientes. Atualmente, foco minha energia no 10º ano de Engenharia da Computação, unindo a bagagem de resolução de problemas do mundo real com o desenvolvimento de software.

- 🔭 Atualmente: Cursando Back-end no Senai RJ - Jacarepaguá.

- 🌱 Estudando: React, Python, JavaScrip e SQL para aplicações robustas.
