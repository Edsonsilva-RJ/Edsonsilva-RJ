...
Sou um profissional em transição de carreira com mais de 10 anos de experiência no setor de serviços, onde desenvolvi competências interpessoais resilientes. Atualmente, foco minha energia no 5º ano de Engenharia da Computação, unindo a bagagem de resolução de problemas do mundo real com o desenvolvimento de software.

- 🔭 Atualmente: Cursando Front-end no Senai Jacarepaguá.

- 🌱 Estudando: React, Python e SQL para aplicações robustas.
